...
| 维度 | 状态 | 详情 |
|------|------|------|
| 整体进度 | 🟡 99% | 新增 final 复核门禁、音频质量指标、实时尾包 flush 和腾讯云实时 ASR |
| 当前阶段 | E 执行 | 自动候选链路、门禁、首音保护、麦克风预热、分段累积、截断复核和腾讯云候选已接入 |
...
| 1.12 | ASR final 复核与音频链路补强 | ✅ | P0 | [E_execution.md](./E_execution.md) |
| 1.13 | 腾讯云实时 ASR 候选接入 | ✅ | P0 | [E_execution.md](./E_execution.md) |
...
| 时间 | 操作 | 说明 |
|------|------|------|
| 05-12 15:46 | ✅ 完成 #1.13 | 接入腾讯云实时 ASR provider、配置、Keychain、健康探测和 UI |
| 05-12 14:36 | ✅ 完成 #1.12 | 新增 final 防截断门禁、完整录音复核、音频质量指标和尾包 flush |
| 05-12 12:18 | ✅ 修复 | 阿里 realtime 分段文本改为累积，不再用后半句覆盖前半句 |
